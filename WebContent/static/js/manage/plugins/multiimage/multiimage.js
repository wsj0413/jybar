...
KindEditor.plugin('multiimage', function(K) {
	...
	var self = this, name = 'multiimage',
		...
		uploadJson = K.undef(self.uploadJson, window.location.protocol + '//' + window.location.host + '/'+   pathName.substring(0,pathName.indexOf('/')) + '/SavePicByStreamServlet?addType='+addType),
		imgPath = self.pluginsPath + 'multiimage/images/',
		imageSizeLimit = K.undef(self.imageSizeLimit, '1MB'),
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png'),
		imageUploadLimit = K.undef(self.imageUploadLimit,focusType=='one'?1 : 20),
