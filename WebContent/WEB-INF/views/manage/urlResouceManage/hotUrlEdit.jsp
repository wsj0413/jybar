...
<body>
	...
	<form id="fm" action="${ctx}/manage/hotUrl/editUrl.do" method="post" onsubmit="return checkForm();">
...
$(function () {
  ...
  //  $('.modal').show();
		  ...
		  $('#cancle').click(function () {
	          window.location.href="${ctx}/manage/hotUrl/list.do?currPage=1&&startDate=&&endDate=";
	      });
